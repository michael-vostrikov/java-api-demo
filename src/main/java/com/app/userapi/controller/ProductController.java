...
public class ProductController {
    ...
    public ResponseEntity<Product> create(@Valid @RequestBody CreateProductDto dto, @AuthenticationPrincipal AppUser user) {
    ...
    public ResponseEntity<Object> save(
        ...
        // Using separate locks allows to keep database transactions open for shorter time,
        // and avoid having application services with @Transactional,
        // which load data by id and check cases like 'not found' and 'access denied'.
        // From my perspective, such services just duplicate functionality of controllers on a higher level.
